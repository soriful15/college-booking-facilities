        ...
        <>
            <footer className="footer p-10 bg-lime-100  text-base-content mt-10">
                <div>
                    ...
                    <p> <span className='lg:text-2xl text-blue-700'>Remakri</span>.<br />Providing reliable tech since 1992 <br /> Dhanmondi, Dhaka-1205 Bangladesh</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <a className="link link-hover">Latest Course</a>
                    <a className="link link-hover">Press kit</a>
                </div>
                <div>
                    <span className="footer-title"> Contact</span>
                    <a className="link link-hover">Email: Remakri@gmail.com</a>
